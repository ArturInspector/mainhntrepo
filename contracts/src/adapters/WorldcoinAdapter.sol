...
import "../interfaces/integrations/IWorldID.sol";
...
contract WorldcoinAdapter is IVerificationAdapter {
    ...
    constructor(address _worldId, address _mainAggregator, string memory _appId, string memory _action) {
    ...
    function verifyAndRegister(address user, bytes calldata proof) external {
        ...
        mainAggregator.registerVerification(user, 0, bytes32(nullifierHash), proof);
